		...
		<table class="product" ref="tableRef">
			...
			<template v-for="line of lines" :key="line.oa?.ID">
				<tr :class="[line.product.Color]" :data-pid="line.product.ID" :data-oaid="line.oa?.ID">
					...
					<td>{{ $value(line.product.years_pastV1) }}</td>
					<td>{{ $value(line.years_pastC2) }}</td>
					<td>{{ $value(line.years_pastT2) }}</td>
					<td>{{ $value(line.product.years_pastV2) }}</td>
					...
					<td>{{ $valueI(line.product.years_pastVe0) }}</td>
					<td>{{ $valueI(line.product.years_pastVe1) }}</td>
					<td>{{ $valueI(line.product.years_pastVe2) }}</td>
				</tr>
			</template>
			</tbody>
		</table>
